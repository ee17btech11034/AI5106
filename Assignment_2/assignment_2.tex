...
\end{align}   
\vspace{0.5 cm}
\vec{D} will be same because both lines are parallel. Passing through mid point \vec{M} of \vec{A}, \vec{B}:
\begin{align}
...
Constant of line is :
\begin{align}
   c =  \begin{pmatrix} 2 & 5 \end{pmatrix}\begin{pmatrix} -1  \\ -4 \end{pmatrix} = -22
\end{align}
